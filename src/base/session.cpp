...
void Session::updateTitleBar()
{
	...
	if (modified_) mainWindow_->setWindowTitle("Quapp v" + QString(QUAPPREVISION) + " - " + inputFile_ + " (modified) ");
	else mainWindow_->setWindowTitle("Quapp v" + QString(QUAPPREVISION) + " - " + inputFile_);
