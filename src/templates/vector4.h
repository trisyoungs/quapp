...
#ifndef QUAPP_VECTOR4_H
#define QUAPP_VECTOR4_H
...
// Operator - (vec3)
template <class T> Vec4<T> Vec4<T>::operator-(Vec3<T> v) const
{
	Vec4<T> result;
	result.x = x-v.x;
	result.y = y-v.y;
...
// Operator * (T)
template <class T> Vec4<T> Vec4<T>::operator*(T v) const
{
