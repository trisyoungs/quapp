...
#ifndef QUAPP_PRIMITIVELIST_H
#define QUAPP_PRIMITIVELIST_H
...
class PrimitiveList
{
	...
	void reinitialise(int newSize, bool allowShrink, int maxVertices, int maxIndices, GLenum type, bool colourData, bool textureData);
	// Add a new primitive to the end of the list
	Primitive* addPrimitive(int maxVertices, int maxIndices, GLenum type, bool colourData, bool textureData);
